        ...
        <div className="container cart-container pb-5 body">
            <nav aria-label="breadcrumb">
                <ol className="breadcrumb">
                    ...
                    <li className="breadcrumb-item"><Link to="/shop">Tienda</Link></li>
            ...
            <div className="mt-3 d-flex flex-column flex-md-row justify-content-md-between">
                <button className="btn btn-success mb-2 mb-md-0 col-12 col-md-4">
                    <Link to="/ticket" style={{ color: "white", textDecoration: "none" }}>Confirmar Pedido</Link>
                </button>
                <button className="btn btn-warning col-12 col-md-4" onClick={handleClearCart}>Vaciar carrito</button>
            </div>
        </div>
    );
};